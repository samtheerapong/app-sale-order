        ...
        <div class="box-body">
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    //     },
                    //     // 'filter' => Html::activeDropDownList($searchModel, 'created_by', ArrayHelper::map(Profile::find()->all(), 'user_id', 'name'), ['class' => 'form-control', 'prompt' => 'ทั้งหมด...'])
                    ...
                    //     'format' => 'html',
                    //     'value' => function ($model) {
                    //         $statusText = $model->status->status_name;
                    //         if ($model->status->id == 1) {
                    //             $statusText .= '<span class="badge blink"> New</span>';
                    //         }
                    //         return '<span class="badge" style="background-color:' . $model->status->status_color . ';"><b>' . $statusText . '</b></span>';
                    //     },
                    //     'filter' => Html::activeDropDownList($searchModel, 'status_id', ArrayHelper::map(Status::find()->all(), 'id', 'status_name'), ['class' => 'form-control', 'prompt' => 'เลือก...'])
                    // ],
                    [
